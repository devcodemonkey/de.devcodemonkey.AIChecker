namespace de.devcodemonkey.AIChecker.UseCases.PluginInterfaces
{
    public interface IMdCharts
    {
        ...
        string CreatePieChart(string path, double[] values, string[] descriptions, int width = 800, int height = 600);
        void CreatePieChartAndAddToMd(string path, string urlPath, double[] values, string[] descriptions, string title, int width = 800, int height = 600);
    }
}